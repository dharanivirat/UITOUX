...
<div class="image">               
    ...
    <div class="d-flex flex-row justify-content-center p-5">
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img  alt="no-images" src="files/images/product-1.jpeg" class="card-img-1" />
            </div>
        ...
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img alt="no-images" src="files/images/product-2.jpeg" class="card-img-1" />
            </div>
        ...
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img alt="no-images" src="files/images/product-3.jpeg" class="card-img-1" />
            </div>
        ...
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img alt="no-images" src="files/images/product-4.jpeg" class="card-img-1" />
            </div>
        ...
        <div class="white-card-1 shadow ml-3">
            ...
            <div class="text-center">
                <img alt="no-images" src="files/images/product-5.jpeg" class="card-img-1" />
            </div>
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3">
        <div>
            <img alt="no-images" src="files/images/product-6.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-images" src="files/images/product-7.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-images" src="files/images/product-8.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
...
<div>
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-images" src="files/images/product-9.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-images" src="files/images/product-10.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-images" src="files/images/product-11.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
...
<div>
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-images" src="files/images/product-12.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
                Brandix Manual Five Speed Gearbox
    ...
    <div class="top-card-1 shadow d-flex flex-row m-3 mt-2">
        <div>
            <img alt="no-images" src="files/images/product-13.jpeg" class="top-img-1" />
        </div>
        <div>
            <p class="heading-1">
...
<div class="d-flex flex-row pb-5">
    ...
    <div>
        ...
        <footer class="">
        <div class="bg-color d-flex flex-row pl-5 pt-5">
          <div>
          ...
          <div class="input-group mb-3">
            ...
            <img  src="files/images/facebook.png" alt="no-images"/>
            <img  src="files/images/twitter.png" alt="no-images"/>
            <img  src="files/images/youtube1.png" alt="no-images"/>
            <img  src="files/images/insta.png" alt="no-images"/>
            <img  src="files/images/rss.png" alt="no-images"/>
        </div>
      ...
      <div class="bottom">
        <div class="d-flex flex-row justify-content-between pt-3">
            <div class="ml-5 ">
                <p class="foot-para ">Powdered by <span class="foot-num1 ">React / Next.Js</span>-Designed by <span class="foot-num1 ">UITOUX SOLUTIONS</span></p>
            </div>
            <div class="mr-5">
                <img alt="no-images" src="files/images/payments.png" />
            </div>
        </div>
    </div>
